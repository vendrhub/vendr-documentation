...
description: API reference for DictionaryExtensions in Vendr, the eCommerce solution for Umbraco v8+
---
...
#### ToKeyedCollection&lt;TValue&gt;

```csharp
public static KeyedCollection<TValue> ToKeyedCollection<TValue>(
