...
public interface IVendrApi : ICountryService, ICurrencyService, IDiscountService, 
    ...
    IOrderStatusService, IPaymentMethodService, IPrintTemplateService, IProductAttributeService, 
    IProductService, ISessionManager, IShippingMethodService, IStoreService, ITaxService
```
