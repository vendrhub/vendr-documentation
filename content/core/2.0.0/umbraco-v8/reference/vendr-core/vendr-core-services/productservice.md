...
description: API reference for ProductService in Vendr, the eCommerce solution for Umbraco
---
## ProductService
...
```csharp
public ProductService(LicensingService licensingService, IRepositoryFactory repositoryFactory, 
    IUnitOfWorkProvider uowProvider, ILogger<ProductService> logger, ICacheAccessor cacheAccessor, 
