...
```csharp
public StoreActionsDto GetStoreActionsForDay(Guid storeId, DateTime date, int localTimezoneOffset)
```
...
```csharp
public StoreStatsDto GetStoreStatsForDay(Guid storeId, DateTime date, int localTimezoneOffset)
```
