---
title: Vendr.Core.Events.Notification
description: API reference for Vendr.Core.Events.Notification in Vendr, the eCommerce solution for Umbraco
---
...
| class [ExportTemplateCreatedNotification](exporttemplatecreatednotification/) |  |
| class [ExportTemplateCreatingNotification](exporttemplatecreatingnotification/) |  |
| class [ExportTemplateDeletedNotification](exporttemplatedeletednotification/) |  |
| class [ExportTemplateDeletingNotification](exporttemplatedeletingnotification/) |  |
| abstract class [ExportTemplateNotificationEventBase&lt;TEntity&gt;](exporttemplatenotificationeventbase-1/) |  |
| class [ExportTemplateSavedNotification](exporttemplatesavednotification/) |  |
| class [ExportTemplateSavingNotification](exporttemplatesavingnotification/) |  |
| class [ExportTemplateUpdatedNotification](exporttemplateupdatednotification/) |  |
| class [ExportTemplateUpdatingNotification](exporttemplateupdatingnotification/) |  |
