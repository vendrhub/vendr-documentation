---
title: OrderService
description: API reference for OrderService in Vendr, the eCommerce solution for Umbraco
---
## OrderService
...
```csharp
public OrderService(LicensingService licensingService, IRepositoryFactory repositoryFactory, 
    IUnitOfWorkProvider uowProvider, ILogger<OrderService> logger, ICacheAccessor cacheAccessor, 
