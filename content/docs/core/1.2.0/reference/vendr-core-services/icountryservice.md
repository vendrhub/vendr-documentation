...
description: API reference for ICountryService in Vendr, the eCommerce solution for Umbraco v8+
---
## ICountryService
...
Sorts a list of [`Country`](../../vendr-core-models/country/) enties by ID according to the order of those IDs
...
| Parameter | Description |
| --- | --- |
| sortedIds | The IDs of the [`Country`](../../vendr-core-models/country/) enties to sort, in the order by which to sort them |
...
Sorts a list of [`Region`](../../vendr-core-models/region/) enties by ID according to the order of those IDs
...
| Parameter | Description |
| --- | --- |
| sortedIds | The IDs of the [`Region`](../../vendr-core-models/region/) enties to sort, in the order by which to sort them |
