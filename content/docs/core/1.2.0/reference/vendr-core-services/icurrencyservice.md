...
| Parameter | Description |
| --- | --- |
| countryId | The ID of the [`Country`](../../vendr-core-models/country/) the [`CurrencyReadOnly`](../../vendr-core-models/currencyreadonly/) entitie should be allowed in |
...
Sorts a list of [`Currency`](../../vendr-core-models/currency/) enties by ID according to the order of those IDs
...
| Parameter | Description |
| --- | --- |
| sortedIds | The IDs of the [`Currency`](../../vendr-core-models/currency/) enties to sort, in the order by which to sort them |
