...
description: API reference for IDiscountService in Vendr, the eCommerce solution for Umbraco v8+
---
## IDiscountService
...
Get a list of [`DiscountRewardProviderDefinition`](../../vendr-core-discounts/discountrewardproviderdefinition/) entities for all [`IDiscountRewardProvider`](../../vendr-core-discounts/idiscountrewardprovider/) instances
...
A list of [`DiscountRewardProviderDefinition`](../../vendr-core-discounts/discountrewardproviderdefinition/) entities
...
Get a [`DiscountRewardProviderScaffold`](../../vendr-core-discounts/discountrewardproviderscaffold/) by [`IDiscountRewardProvider`](../../vendr-core-discounts/idiscountrewardprovider/) Alias
...
| Parameter | Description |
| --- | --- |
| alias | The Alias of the [`IDiscountRewardProvider`](../../vendr-core-discounts/idiscountrewardprovider/) to create a [`DiscountRewardProviderScaffold`](../../vendr-core-discounts/discountrewardproviderscaffold/) for |

**Returns**

A [`DiscountRewardProviderScaffold`](../../vendr-core-discounts/discountrewardproviderscaffold/)
...
Get a list of [`DiscountRuleProviderDefinition`](../../vendr-core-discounts/discountruleproviderdefinition/) entities for all [`IDiscountRuleProvider`](../../vendr-core-discounts/idiscountruleprovider/) instances
...
A list of [`DiscountRuleProviderDefinition`](../../vendr-core-discounts/discountruleproviderdefinition/) entities
...
Get a [`DiscountRuleProviderScaffold`](../../vendr-core-discounts/discountruleproviderscaffold/) by [`IDiscountRuleProvider`](../../vendr-core-discounts/idiscountruleprovider/) Alias
...
| Parameter | Description |
| --- | --- |
| alias | The Alias of the [`IDiscountRuleProvider`](../../vendr-core-discounts/idiscountruleprovider/) to create a [`DiscountRuleProviderScaffold`](../../vendr-core-discounts/discountruleproviderscaffold/) for |

**Returns**

A [`DiscountRuleProviderScaffold`](../../vendr-core-discounts/discountruleproviderscaffold/)
