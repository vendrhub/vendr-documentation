...
description: API reference for IEmailTemplateService in Vendr, the eCommerce solution for Umbraco v8+
---
...
Sorts a list of [`EmailTemplate`](../../vendr-core-models/emailtemplate/) enties by ID according to the order of those IDs
...
| Parameter | Description |
| --- | --- |
| sortedIds | The IDs of the [`EmailTemplate`](../../vendr-core-models/emailtemplate/) enties to sort, in the order by which to sort them |
