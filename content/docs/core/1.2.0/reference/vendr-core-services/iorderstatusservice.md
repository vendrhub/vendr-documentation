...
description: API reference for IOrderStatusService in Vendr, the eCommerce solution for Umbraco v8+
---
## IOrderStatusService
...
Sorts a list of [`OrderStatus`](../../vendr-core-models/orderstatus/) enties by ID according to the order of those IDs
...
| Parameter | Description |
| --- | --- |
| sortedIds | The IDs of the [`OrderStatus`](../../vendr-core-models/orderstatus/) enties to sort, in the order by which to sort them |
