...
description: API reference for IPaymentMethodService in Vendr, the eCommerce solution for Umbraco v8+
---
...
Sorts a list of [`PaymentMethod`](../../vendr-core-models/paymentmethod/) enties by ID according to the order of those IDs
...
| Parameter | Description |
| --- | --- |
| sortedIds | The IDs of the [`PaymentMethod`](../../vendr-core-models/paymentmethod/) enties to sort, in the order by which to sort them |
