...
description: API reference for IShippingMethodService in Vendr, the eCommerce solution for Umbraco v8+
---
...
Sorts a list of [`ShippingMethod`](../../vendr-core-models/shippingmethod/) enties by ID according to the order of those IDs
...
| Parameter | Description |
| --- | --- |
| sortedIds | The IDs of the [`ShippingMethod`](../../vendr-core-models/shippingmethod/) enties to sort, in the order by which to sort them |
