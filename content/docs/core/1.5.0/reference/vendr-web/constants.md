...
| Options | `9` | Alias for a options node. |
| ProductAttributes | `10` | Alias for a product attributes node. |
| ProductAttribute | `11` | Alias for a product attribute node. |
| ProductAttributePresets | `12` | Alias for a product attribute presets node. |
| ProductAttributePreset | `13` | Alias for a product attribute preset node. |
