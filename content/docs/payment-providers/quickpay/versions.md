...
Next version of the QuickPay payment provider documentation
...
There is currently no next version of the QuickPay payment provider documentation available

</template>

## Current Version
Current version of the QuickPay payment provider documentation 
...
Previous versions of the QuickPay payment provider documentation
...
There are currently no previous versions of the QuickPay payment provider documentation available
