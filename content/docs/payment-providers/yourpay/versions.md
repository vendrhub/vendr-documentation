...
Next version of the Yourpay payment provider documentation
...
There is currently no next version of the Yourpay payment provider documentation available

</template>

## Current Version
Current version of the Yourpay payment provider documentation 
...
Previous versions of the Yourpay payment provider documentation
...
There are currently no previous versions of the Yourpay payment provider documentation available
